...
def main():
    ...
    rows = [
        {'symbol':'AAA','elite_pass':True,'trade_plan':{'days_max':5}},
        {'symbol':'BBB','elite_pass':False,'trade_plan':{'days_max':5}},
    ]
        ...
        p.write_text(json.dumps({
            'version':1,'updated_at':None,'symbols':{
                'AAA':{
                    ...
                    'source_day_diff':0,'checked_at':'2026-08-13T11:00:00+00:00','stale':False,
                }
            }
        }),encoding='utf-8')
