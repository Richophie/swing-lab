...
'WMT':'월마트','COST':'코스트코','HD':'홈디포','LOW':'로우스','TGT':'타깃','TJX':'TJX 컴퍼니스','NKE':'나이키','SBUX':'스타벅스','MCD':'맥도날드','KO':'코카콜라','PEP':'펩시코','PG':'프록터앤드갬블','PM':'필립모리스','MDLZ':'몬델리즈','KHC':'크래프트 하인즈','HRL':'호멜 푸즈','SYY':'시스코','M':'메이시스',
...
def korean_name(symbol:str, security_name:str|None=None)->str:
    ...
    # We never invent a company translation. Unknown names use the official security name
    # until a verified Korean alias is added to KO_NAMES.
