...
STATIC=ROOT/'static';SCAN_FILE=STATIC/'latest_scan.json';HISTORY_FILE=STATIC/'trade_history.json'
...
def usdkrw_rate():
    try:
        d=fresh_price_history('KRW=X','5d');value=float(d['Close'].dropna().iloc[-1]);return round(value,2)
